 ...
 */
public class HashIndexDocument implements Comparable {
    private Integer indexDocNumber;
    private Set<Integer> wordHashes;

    public HashIndexDocument(Integer indexDocNumber) {
    ...
    public int compareTo(Object o) {
        if (o instanceof HashIndexDocument) {
            return this.wordHashes.size() > ((HashIndexDocument) o).wordHashesSize()?1:0;
        }
        return 0;
    }
