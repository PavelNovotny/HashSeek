 ...
 */
public class AuditLogTransformer extends AbstractLogTransformer{
    static final Logger LOGGER= LoggerFactory.getLogger(AuditLogTransformer.class);

    @Override
    public boolean canBeProcessed(File file) {
        boolean result=file.getName().contains("audit");
        return result;
    }
